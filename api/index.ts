...
import labourRequestRoutes from './routes/labourRequests';
import deploymentRoutes from './routes/deployments';
import commercialTimesheetRoutes from './routes/commercialTimesheets';
import commercialInvoiceRoutes from './routes/commercialInvoices';
import incidentRoutes from './routes/incidents';
import kidRoutes from './routes/kids';
import performanceRoutes from './routes/performance';
import materialRoutes from './routes/materials';
import deploymentMediaRoutes from './routes/deploymentMedia';
...
app.route('/api/labour-requests', labourRequestRoutes);
app.route('/api/deployments', deploymentRoutes);
app.route('/api/commercial-timesheets', commercialTimesheetRoutes);
app.route('/api/commercial-invoices', commercialInvoiceRoutes);
app.route('/api/incidents', incidentRoutes);
app.route('/api/kids', kidRoutes);
app.route('/api/performance', performanceRoutes);
app.route('/api/materials', materialRoutes);
app.route('/api/deployment-media', deploymentMediaRoutes);
